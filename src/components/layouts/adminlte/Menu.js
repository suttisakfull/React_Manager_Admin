...
const Menu = () => {
  return (
    <aside className="main-sidebar sidebar-dark-success elevation-2">
      {/* Brand Logo */}
      {/* <a href="index3.html" className="brand-link"> */}
      {/* <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" className="brand-image img-circle elevation-3" style={{ opacity: '.8' }} /> */}
      <span className="brand-text font-weight-light">Global:</span>
      {/* </a> */}
      {/* Sidebar */}
      <div className="sidebar">
        ...
        <img src="dist/img/user2-160x160.jpg" className="img-circle elevation-2" alt="User Image" />
          ...
          {/* <div className="info">
        <a href="#" className="d-block">Global:</a>
      </div> */}
        </div>
        {/* SidebarSearch Form */}
            ...
            เพิ่มกิจกรรม
              ...
              <ul className="nav nav-treeview">
                <li className="nav-item">
                  ...
                  <Link to="/insert-event" className="nav-link active">
                ...
                <li className="nav-item">
                  ...
                  <Link to="/insert-training" className="nav-link">
                    <i className="far fa-circle nav-icon" />
                    <p>เพิ่มการฝึกอบรม</p>
                  </Link>
                ...
                <li className="nav-item">
                  ...
                  <Link to="/insert-camp" className="nav-link">
                    <i className="far fa-circle nav-icon" />
                    <p>เพิ่มแคมป์</p>
                  </Link>
                ...
                <li className="nav-item">
                  ...
                  <Link to="/insert-club" className="nav-link">
                    <i className="far fa-circle nav-icon" />
                    <p>เพิ่มสโมสร</p>
                  </Link>
                ...
                <li className="nav-item">
                  ...
                  <Link to="/insert-typeevent" className="nav-link">
                    <i className="far fa-circle nav-icon" />
                    <p>เพิ่มกิจกรรม(หลัก/รอง)</p>
                  </Link>
